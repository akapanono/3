...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--top_ratio_ema_ratio", type=float, default=0.10)
    parser.add_argument("--top_ratio_min_samples", type=int, default=1)
    parser.add_argument("--top_ratio_momentum", type=float, default=0.995)
    parser.add_argument("--top_ratio_warmup_epochs", type=int, default=2)
